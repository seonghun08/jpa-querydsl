...
import jpabook.jpashop.repository.support.Querydsl4RepositorySupport;
...
@Repository
public class MemberQuerydsl4SupportRepository extends Querydsl4RepositorySupport {

    public MemberQuerydsl4SupportRepository() {
        super(Member.class);
    }
